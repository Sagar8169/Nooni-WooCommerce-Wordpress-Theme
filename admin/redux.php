...
add_action('after_setup_theme', 'nooni_register_redux', 9);
function nooni_register_redux(){
	// This is your option name where all the Redux data is stored.
	$opt_name = 'nooni_theme_options';
	...
	$args = array(
		...
		'menu_title'           => esc_html__( 'Theme Options', 'nooni' ),
		'page_title'           => esc_html__( 'Theme Options', 'nooni' ),
		...
		'global_variable'      => 'nooni_theme_options',
	...
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'General', 'nooni' )
		,'id'               => 'general-tab'
		,'desc'             => ''
		,'icon'             => 'el el-home'
	...
	/*** Color Scheme Tab ***/
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'Color Scheme', 'nooni' )
		,'id'               => 'color-scheme-tab'
		,'desc'             => ''
		,'icon'             => 'el el-brush'
	...
	/*** Typography Tab ***/
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'Typography', 'nooni' )
		,'id'               => 'typography-tab'
		,'desc'             => ''
		,'icon'             => 'el el-font'
	...
	/*** WooCommerce Tab ***/
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'WooCommerce', 'nooni' )
		,'id'               => 'woocommerce-tab'
		,'desc'             => ''
	...
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'Shop/Product Category', 'nooni' )
	...
	/*** Product Details Tab ***/
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'Product Details', 'nooni' )
	...
	/*** Custom Code Tab ***/
	Redux::set_section( $opt_name, array(
		'title'             => esc_html__( 'Custom Code', 'nooni' )
		,'id'               => 'custom-code-tab'
		,'desc'             => ''
		,'icon'             => 'el el-edit'
