...
$page_column_class = nooni_page_layout_columns_class($page_options['ts_page_layout']);
...
if( $show_breadcrumb || $show_page_title ){
	$extra_class = 'show_breadcrumb_'.nooni_get_theme_options('ts_breadcrumb_layout');
}
