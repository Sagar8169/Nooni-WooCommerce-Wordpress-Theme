		...
		<div class="header-template">
			...
			<div class="header-top">
				<div class="container">	
					...
					<div class="header-center"><?php nooni_store_notices(); ?></div>
				...
				<div class="header-middle">
					<div class="container">
						<div class="header-left">
							<div class="logo-wrapper"><?php nooni_theme_logo(); ?></div>
						</div>
								...
								<div class="ts-menu">
									<?php 
										if ( has_nav_menu( 'primary' ) ) {
											wp_nav_menu( array( 'container' => 'nav', 'container_class' => 'main-menu pc-menu ts-mega-menu-wrapper','theme_location' => 'primary','walker' => new Nooni_Walker_Nav_Menu() ) );
										}
										else{
						...
						<div class="header-right">
							...
							<?php if( class_exists('YITH_WCWL') && $nooni_theme_options['ts_enable_tiny_wishlist'] ): ?>
								<div class="my-wishlist-wrapper visible-phone"><?php echo nooni_tini_wishlist(); ?></div>
							<?php endif; ?>
							
							<?php if( $nooni_theme_options['ts_enable_tiny_shopping_cart'] ): ?>
							<div class="shopping-cart-wrapper visible-phone">
								<?php echo nooni_tiny_cart(true, false); ?>
							</div>
							<?php endif; ?>
